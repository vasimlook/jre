...
$.fn.popover.Constructor.prototype.leave = function(a) {
    ...
    init_sparklines(), init_sidebar(), init_InputMask(), init_JQVmap(), init_cropper(), init_knob(), init_daterangepicker(), init_daterangepicker_right(), init_daterangepicker_single_call(), init_daterangepicker_reservation(), init_select2(), init_validator(), init_chart_doughnut(), init_gauge(), init_starrr(), init_calendar(),init_autosize(), init_autocomplete(),init_CustomNotification(), init_DataTables(),init_wysiwyg()
//    init_flot_chart(),init_IonRangeSlider(), init_ColorPicker(), init_TagsInput(), init_parsley(),init_SmartWizard(), init_skycons(),init_compose(),,init_EasyPieChart(),init_charts() , init_morris_charts()
});